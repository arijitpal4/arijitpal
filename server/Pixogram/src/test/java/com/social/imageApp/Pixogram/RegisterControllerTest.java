...
public class RegisterControllerTest {
	...
	public void registerUser() throws Exception
	{
		...
		mockUser.setUsername("Arijit Pal");
		mockUser.setFirstName("Arijit");
		mockUser.setLastName("Pal");
		mockUser.setEmail("abcdef@gmail.com");
		mockUser.setPassword("Arijit");
		mockUser.setProfilePicture("image");
		mockUser.setAbout("Arijit");
	...
	public void checkUsername() throws Exception
	{
		...
		mockUser1.setUsername("Arijit Pal");
		mockUser1.setFirstName("Arijit");
		mockUser1.setLastName("Pal");
		mockUser1.setEmail("abcdef@gmail.com");
		mockUser1.setPassword("Arijit");
		mockUser1.setProfilePicture("image");
		mockUser1.setAbout("Arijit");
